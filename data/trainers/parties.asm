...
; Pokémon Tower 2F
	...
	db $FF, 25, FEAROW, 23, VULPIX, 22, SHELLDER, 20, SANDSHREW, 25, PIKACHU, 0
	db $FF, 25, FEAROW, 23, VULPIX, 22, SHELLDER, 20, SANDSHREW, 25, PIKACHU, 0
; Silph Co. 7F
...
; Route 22
	...
	db $FF, 47, SANDSLASH, 45, EXEGGCUTE, 45, CLOYSTER, 47, NINETALES, 50, KADABRA, 53, RAICHU, 0
	db $FF, 47, SANDSLASH, 45, EXEGGCUTE, 45, CLOYSTER, 47, NINETALES, 50, KADABRA, 53, RAICHU, 0

Rival3Data:
; Champion's Room
	db $FF, 61, SANDSLASH, 59, ALAKAZAM, 61, EXEGGUTOR, 61, CLOYSTER, 63, NINETALES, 65, RAICHU, 0
	db $FF, 61, SANDSLASH, 59, ALAKAZAM, 61, EXEGGUTOR, 61, NINETALES, 63, CLOYSTER, 65, RAICHU, 0
	db $FF, 61, SANDSLASH, 59, ALAKAZAM, 61, EXEGGUTOR, 61, NINETALES, 63, CLOYSTER, 65, RAICHU, 0
